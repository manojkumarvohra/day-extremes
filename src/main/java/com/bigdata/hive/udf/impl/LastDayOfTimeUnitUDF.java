...
@Description(name = "last_day_of", value = "_FUNC_(unit, input_date, format, include_interval, interval) - Returns the last date for unit (day/week/month/quarter/year) "
...
public class LastDayOfTimeUnitUDF extends AbstractDayOfTimeUnitUDF {
	...
	public void calculateDayOfQuarterWithInterval(Date date, boolean includeInterval, Integer[] interval) {
		...
		setOutputDate(includeInterval, lastDayOfQuarterWithInterval);
	}
